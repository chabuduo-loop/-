...
class DongmanDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class Random_Proxy(object):
    def __init__(self):
        self.proxy_url = r"http://api.wandoudl.com/api/ip?app_key=bdfff8ff91f441bc07272adc5f8e26e1&pack=0&num=20&xy=1&type=2&lb=\r\n&port=4&mr=1&"
    ...
    def process_request(self, request , spider):
        ...
        if self.eve_count == 10:
            ...
            self.eve_count += 1
            print(self.proxy_list[self.count-1])
